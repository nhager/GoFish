    ...
    private void setNextButtonOnClickListener() {
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                email = ((EditText)findViewById(R.id.registerUserEmail)).getText().toString();
                password = ((EditText)findViewById(R.id.registerUserPassword)).getText().toString();
                if (email == null || email.equals("") || password == null || password.equals(null)) return;
